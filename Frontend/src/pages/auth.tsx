      ...
      <section className="auth-card">
        <div className="auth-card__hero">
          ...
          <div className="auth-card__highlights">
            <article className="auth-highlight">
              ...
              <span>
                Enter with a lender ID and keep building the real lender flow.
              </span>
            </article>
            <article className="auth-highlight">
              <strong>Lender-scoped analytics</strong>
              <span>
                The signed-in lender ID becomes the data key for analytics
                requests.
              </span>
            </article>
            <article className="auth-highlight">
              ...
              <span>
                This local session can be swapped with real auth when your
                partner finishes it.
              </span>
            </article>
          </div>
        ...
        <div className="auth-card__form-panel">
          <div
            className="auth-tabs"
            role="tablist"
            aria-label="Temporary auth mode"
          >
            <button
              type="button"
          ...
          {activeMode === "login" ? (
            <form className="auth-form" onSubmit={handleLoginSubmit}>
              ...
              <p className="auth-helper">
                If this lender was already created locally, we reuse that
                profile. Otherwise, we still let you enter with the typed lender
                ID.
              </p>
            </form>
          ) : (

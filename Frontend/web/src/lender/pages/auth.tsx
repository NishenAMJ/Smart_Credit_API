  ...
  const authCopy = useMemo(() => {
    return activeMode === "login"
      ? {
          ...
          title: "Sign in to Smart Credit+",
          subtitle:
            "Use your email or phone with your password to open the lender workspace.",
          buttonLabel: "Sign in",
        }
      : {
          ...
          subtitle:
            registerStep === "account"
              ? "Start with account details, then continue to the KYC step used by the backend."
              : "Submit matching identity details and clear files so your lender account can be reviewed.",
          buttonLabel:
        ...
        <div className="auth-card__hero">
          ...
          <div className="auth-card__highlights">
            <article className="auth-highlight">
              <strong>Backend-backed sign-in</strong>
              <span>Your session token comes from the real auth API.</span>
            </article>
            <article className="auth-highlight">
              <strong>Two-step onboarding</strong>
              <span>Account creation and KYC stay in one guided flow.</span>
            </article>
            <article className="auth-highlight">
        ...
        <div className="auth-card__form-panel">
          ...
          {activeMode === "signup" ? (
            <div className="auth-step-row">
              <span
                className={`auth-step-pill${
                  registerStep === "account"
                    ? " auth-step-pill--active"
                    : " auth-step-pill--complete"
                }`}
              >
                Account
              </span>
              <span
                className={`auth-step-pill${
                  registerStep === "kyc" ? " auth-step-pill--active" : ""
                }`}
              >
                KYC
              </span>
          ...
          {activeMode === "login" ? (
            <form className="auth-form" onSubmit={handleLoginSubmit}>
              ...
              <p className="auth-helper">
                The backend confirms the lender role after authentication and
                opens the lender dashboard with that session.
              </p>
            </form>
          ) : (

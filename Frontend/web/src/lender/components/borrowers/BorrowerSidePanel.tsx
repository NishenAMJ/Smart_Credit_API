  ...
  useEffect(() => {
    ...
    const loadBorrower = async () => {
      try {
        ...
        setBorrower(null);
        setView("loans");
        const details = await fetchBorrowerDetails(borrowerId);
              ...
              <div className="borrower-panel-loan-list">
                {borrower.loans.length > 0 ? (
                  borrower.loans.map((loan) => (
                    <article className="borrower-panel-loan-card" key={loan.id}>
                      <div>
                      ...
                      <dl>
                        <div>
                          <dt>Remaining</dt>
                          <dd>{formatCurrency(loan.remainingAmount)}</dd>
                        </div>
                        <div>
                          <dt>Interest</dt>
                          <dd>{loan.interestRate.toFixed(1)}%</dd>
                        </div>
                        <div>
                          <dt>Tenure</dt>

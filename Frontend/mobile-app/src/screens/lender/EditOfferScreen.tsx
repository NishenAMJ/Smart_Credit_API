...
export default function EditOfferScreen({ navigation, route }: any) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Error', e?.response?.data?.message ?? 'Failed to update offer');
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={commonStyles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput style={styles.input} value={minAmount} onChangeText={setMinAmount}
              keyboardType="numeric" editable={!submitting} />
          </View>
          <View style={styles.inputGroup}>
            <Text style={commonStyles.textSecondary}>Maximum</Text>
            <TextInput style={styles.input} value={maxAmount} onChangeText={setMaxAmount}
              keyboardType="numeric" editable={!submitting} />
          </View>
        </View>
        ...
        <View style={commonStyles.card}>
          <View style={commonStyles.rowSpaceBetween}>
            ...
            <TextInput
              ...
              value={tenure} onChangeText={setTenure} keyboardType="numeric"
              editable={!submitting}
            />
          </View>
...
const styles = StyleSheet.create({
  ...
  readOnly: { flexDirection: 'row', alignItems: 'center', paddingVertical: 16, gap: 12 },

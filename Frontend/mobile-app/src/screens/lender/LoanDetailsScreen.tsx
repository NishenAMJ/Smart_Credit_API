          ...
          <View style={commonStyles.rowSpaceBetween}>
            <View>
              ...
              <Text style={styles.largeText}>
                LKR {principalAmount.toLocaleString()}
              </Text>
            </View>
            ...
            <View style={{ alignItems: "center" }}>
              <Text
                style={[
                  ...
                  {
                    color:
                      overdueCount > 0 ? COLORS.danger : COLORS.textSecondary,
                  },
                ]}
              >
                {overdueCount}
        ...
        {nextInstallment && (
          <View style={commonStyles.card}>
            ...
            <View style={styles.dueBox}>
              ...
              <Text style={styles.largeText}>
                LKR {nextDueAmount.toLocaleString()}
              </Text>
              ...
              return (
                ...
                >
                  <View style={commonStyles.row}>
                    <View
                      style={[styles.instDot, { backgroundColor: instColor }]}
                    />
                    <Text style={commonStyles.textSecondary}>
                      #{idx + 1} ·{" "}
                      {inst.dueDate
                  ...
                  <View style={{ alignItems: "flex-end" }}>
                    <Text
                      style={[commonStyles.textPrimary, { color: instColor }]}
                    >
                      {(inst.status ?? "pending").toUpperCase()}
                    </Text>
                    <Text style={commonStyles.textSecondary}>
                      LKR {(inst.paidAmount ?? 0).toLocaleString()}/

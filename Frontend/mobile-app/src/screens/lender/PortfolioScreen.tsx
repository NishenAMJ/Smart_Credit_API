  ...
  const categories = [
    ...
    },
    {
      ...
      details: [
        ...
        { label: 'Conversion Rate',   value: pct(perf.requestToLoanConversionRate)   },
    ...
    },
    {
      ...
      details: [
        ...
        { label: 'Avg Tenure',        value: port.averageTenureMonths != null ? `${Number(port.averageTenureMonths).toFixed(0)} months` : '--' },
        { label: 'Avg Credit Score',  value: risk.averageBorrowerCreditScore != null ? String(risk.averageBorrowerCreditScore) : '--' },
      ],
    },
  ];
    ...
    <SafeAreaView style={commonStyles.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
        ...
        <View style={styles.summaryGrid}>
          <StatCard icon="briefcase"   color={COLORS.primary} value={num(sum.activeLoans)}    label="Active Loans"   />
        ...
        <View style={[styles.summaryGrid, { marginBottom: 16 }]}>
          ...
          <StatCard icon="alert-circle" color={COLORS.danger}  value={num(risk.overdueLoans)}   label="Overdue Loans"  />
        </View>
            ...
            >
              ...
              {expandedId === item.id && (
                <View style={styles.expandedContent}>
                  {item.details.map((d) => (
                    <View key={d.label} style={[commonStyles.rowSpaceBetween, { paddingVertical: 4 }]}>
        ...
        {port.outstandingAmount != null && (
          <View style={commonStyles.card}>
            ...
            <Text style={styles.outstandingText}>{fmt(port.outstandingAmount)}</Text>

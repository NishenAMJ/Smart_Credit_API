  ...
  const repaymentDocs = [
    {
      ...
      transactionReference: 'TX-NIMAL-ACT-001',
      paymentProofUrl: 'https://example.com/payments/nimal-active-001.jpg',
      status: 'completed',
    ...
    },
    {
      ...
      transactionReference: 'TX-NIMAL-ACT-002',
      paymentProofUrl: 'https://example.com/payments/nimal-active-002.jpg',
      status: 'completed',
    ...
    },
    {
      ...
      interestPaid: 1200,
      paymentMethod: 'card',
      transactionReference: 'TX-NIMAL-COMP-001',
      paymentProofUrl: 'https://example.com/payments/nimal-completed-001.jpg',
      status: 'completed',
    ...
    },
    {
      ...
      interestPaid: 1100,
      paymentMethod: 'qr_payment',
      transactionReference: 'TX-NIMAL-COMP-002',
      paymentProofUrl: 'https://example.com/payments/nimal-completed-002.jpg',
      status: 'completed',
    ...
    },
    {
      ...
      interestPaid: 1000,
      paymentMethod: 'bank_transfer',
      transactionReference: 'TX-NIMAL-COMP-003',
      paymentProofUrl: 'https://example.com/payments/nimal-completed-003.jpg',
      status: 'completed',
